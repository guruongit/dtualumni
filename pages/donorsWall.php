...
<div class="md:w-2/5 px-10">
  ...
  <div class="grid grid-row-1 divide-y-2 gap-2 sm:grid-row-2 text-left text-xl my-4">
    ...
    <p class=" text-gray-500 pt-6 italic">
      TThe Cheque/Draft for institution of Medals & Scholarship may be issued in
      the favour of:
      <br>
...
<div class="w-full snap-start" id="corpus">
  <div class="min-h-screen lg:flex flex-row-reverse container  mx-auto items-center ">
<div class="lg:w-2/5 text-center lg:text-start px-5 lg:pr-10">
  <h2 class="text-4xl font-bold">
                      ...
                      // echo $i;
                        ...
                        echo '<div class="swiper-slide "> 
                                <div class=" flex flex-col rounded shadow overflow-hidden">
                                  ...
                                  onclick="showPopups('.$make.', this.children[2].innerHTML, this.children[1].children[0].innerHTML)" onmouseover="alumHover(this)" onmouseleave="alumHoverOut(this)" 
                                  >
                                    <img class="h-[40vh] w-full object-cover imageCorpus"
                                      src='.$get.'
                                      onerror="this.src='.$def.'" alt="">
                                    <div class="absolute bottom-0 p-6  z-50 alumni-content text-white drop-shadow-[0_1.5px_1.5px_rgba(0,0,0,0.8)]">
                                      <p class="text-xl md:text-2xl  lg:text-3xl font-semibold nameCorpus">'.$array_data[$i]['name'].'</p>
                                      <p class="classCorpus">'.$array_data[$i]['amount'].'</p>
                                    </div>
                                    <div
                                      class="absolute z-40 top-0 bg-black bg-opacity-75 h-full alumni-text ease-in-out duration-300 p-6 text-white text-md md:text-lg lg:text-xl textCorpus ">
                                      '.$array_data[$i]['purpose'].'
          ...
          <!-- <div class="swiper-slide  ">
            <div class="flex flex-col rounded shadow overflow-hidden">
              ...
              <img class="h-[40vh] w-full object-cover imageCorpus"
                  ...
                  onerror="this.src='../public/img/blank-profile-picture.png'" alt="">
                <div class="absolute bottom-0 p-6  z-50 alumni-content text-white drop-shadow-[0_1.5px_1.5px_rgba(0,0,0,0.8)]">
                  <p class="text-xl md:text-2xl  lg:text-3xl font-semibold nameCorpus"></p>
                  <p class="classCorpus"></p>
                </div>
                <div
                  class="absolute z-40 top-0 bg-black bg-opacity-75 h-full alumni-text ease-in-out duration-300 p-6 text-white text-md md:text-lg lg:text-xl textCorpus">
