...
<nav class="bg-white border-gray-200 px-2 lg:px-4 py-2.5 bg-gray-900">
  ...
  <section class="relative">
    ...
    <!-- </div> swiper init div -->
      <div
        class="z-20 md:absolute top-0  right-0 md:w-[28%] md:h-full   my-0 bg-black bg-opacity-50 text-white py-5 md:rounded-md">
  ...
  <section class="bg-white " id="statistics">
    <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
      <dl class="grid max-w-screen-lg gap-8 mx-auto text-gray-900 grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 ">
        ...
        <div class="flex flex-col items-center justify-center">
          <dt class="mb-2 text-3xl md:text-4xl font-extrabold"><p class="inline counter">9</p>cr+</dt>
          <dd class="font-light text-gray-500 ">Donations recieved</dd>
        </div>
        <div class="flex flex-col items-center justify-center">
          <dt class="mb-2 text-3xl md:text-4xl font-extrabold"><p class="inline counter">1</p>cr+</dt>
